            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {project.github && (
                <a
                  ...
                  className="inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-gradient-to-r from-slate-800 to-slate-700 border border-slate-600/50 hover:border-slate-500 hover:shadow-lg hover:shadow-slate-500/20 transition-all duration-300 group cursor-target"
                >
              ...
              {project.demo && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-gradient-to-r from-primary/20 to-accent/20 border border-primary/30 hover:border-primary/50 hover:shadow-lg hover:shadow-primary/20 transition-all duration-300 group cursor-target"
                  style={{
