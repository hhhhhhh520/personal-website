...
function CategoryBadge({ category }: { category: Project["category"] }) {
  const categoryConfig = {
    ai: { label: "AI", className: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
    android: { label: "Android", className: "bg-green-500/15 text-green-400 border-green-500/30" },
    web: { label: "Web", className: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
    tool: { label: "Tool", className: "bg-orange-500/15 text-orange-400 border-orange-500/30" },
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedFade>
            ...
            >
              ...
              <span className="text-secondary group-hover:text-primary transition-colors">返回项目列表</span>
            </Link>
          </AnimatedFade>
          ...
          <AnimatedSection>
            <div className="glass rounded-xl p-6 mb-6">
              <p className="text-lg text-secondary leading-relaxed">{project.shortDesc}</p>
            </div>
          </AnimatedSection>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {project.github && (
                ...
                >
                  ...
                  <span className="text-white/90 font-medium group-hover:text-white transition-colors">View on GitHub</span>
              ...
              {project.demo && (
                ...
                >
                  ...
                  <span className="text-accent/90 font-medium group-hover:text-accent transition-colors">Live Demo</span>
