...
export function getTimeGreeting(): string {
  ...
  if (hour >= 5 && hour < 9) {
    return '早上好！☀️ 新的一天开始了，苏畅正在开启新的代码之旅。需要我带你探索他的作品吗？';
  } else if (hour >= 9 && hour < 12) {
    return '上午好！苏畅正在专注开发中，有什么想了解的尽管问我！';
  } else if (hour >= 12 && hour < 14) {
    return '中午好！🍜 该休息一下吃午饭了吧？苏畅通常这时候会看看技术博客放松一下~';
  } else if (hour >= 14 && hour < 18) {
    return '下午好！这是苏畅效率最高的时段，很多项目都是在这个时间完成的。想看看他的作品吗？';
  } else if (hour >= 18 && hour < 22) {
    return '晚上好！🌙 苏畅喜欢晚上写代码，说是灵感最活跃的时候。有什么想聊的吗？';
  } else {
